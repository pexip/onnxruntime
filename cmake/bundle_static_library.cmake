...
# https://github.com/csukuangfj/onnxruntime-build/blob/main/static_lib/bundle_static_library.cmake
...
function (build_bundle)
	bundle_static_library(onnxruntime_bundle onnxruntime_session
...
if (BUILD_PKGCONFIG_FILES)
	set(ONNX_INCLUDE_DIRS
					${CMAKE_INSTALL_PREFIX}/include/onnxruntime
					${CMAKE_INSTALL_PREFIX}/include/onnxruntime/core
					${CMAKE_INSTALL_PREFIX}/include/onnxruntime/core/session
			)  

	if(ONNX_INCLUDE_DIRS)
			foreach(dir IN LISTS ONNX_INCLUDE_DIRS)
					list(APPEND ONNX_CFLAGS "-I${dir}")
			endforeach()
			string(JOIN " " ONNX_CFLAGS ${ONNX_CFLAGS})
	else()
			set(ONNX_CFLAGS "")
	endif()
	configure_file(${CMAKE_CURRENT_SOURCE_DIR}/libonnxruntime_bundle.pc.cmake.in
	${CMAKE_CURRENT_BINARY_DIR}/libonnxruntime_bundle.pc @ONLY)
	install( FILES  ${CMAKE_CURRENT_BINARY_DIR}/libonnxruntime_bundle.pc DESTINATION
